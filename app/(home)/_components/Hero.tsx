  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center pt-10 pb-2">
      <div>
        ...
        <h1 className="text-5xl md:text-7xl leading-heading mt-5 mb-5 font-display font-semibold text-espresso">
          Where projects take shape.
        </h1>
        <p className="text-lg md:text-2xl leading-body max-w-lg text-espresso">
        ...
        <p className="text-sm italic text-cinnamon mt-4">
