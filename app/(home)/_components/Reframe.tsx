...
export default function Reframe() {
  return (
    <section className="bg-sand rounded-lg px-6 py-14 md:px-10 md:py-16 text-center my-24">
      ...
      <h2 className="text-3xl md:text-5xl leading-heading mt-4 mb-6 font-display font-semibold text-espresso">
        Turn scattered information<br className="hidden md:block" /> into clear direction.
      </h2>
      <p className="text-lg md:text-xl max-w-xl mx-auto mb-10 text-espresso/90">
      ...
      <div className="flex flex-wrap justify-center gap-3.5 max-w-3xl mx-auto">
        {steps.map((s) => (
          <span key={s} className="bg-cream-soft border border-latte rounded-full px-5 py-2.5 text-sm font-medium">
            {s}
          </span>
        ))}
      </div>
